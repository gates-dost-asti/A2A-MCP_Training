...
wiki = wikipediaapi.Wikipedia(
    user_agent="MyResearchAgent/1.0 (your_email@example.com)",
    language="en"
)
...
tavily_tool_def = {
    ...
    "description": "Performs a general-purpose web search specially for news and recent events using the Tavily API.",
    "parameters": {
        "type": "object",
        "properties": {
            "query": {
...
def wikipedia_search_tool(query: str, sentences: int = 5) -> list[dict]:
    ...
    try:
        ...
        return [{
            "title": page.title,
            "summary": page.summary[:3000],  # or however much you want
            "url": page.fullurl
        }]
